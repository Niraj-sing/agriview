(function () {
  ...
  function validMessage(message) {
    return message.length >= 1 && message.length <= 300;
  }
  ...
  if (supportForm) {
    ...
    supportForm.addEventListener(
      ...
      async function (e) {
        ...
        var name =
          byId("sName").value.trim();

        var email =
          byId("sEmail").value.trim();

        var subject =
          byId("sSubject").value.trim();

        var message =
          byId("sMessage").value.trim();

        var honeypot =
          byId("supportFormWebsite");
        ...
        try {
          ...
          setStatus(
            supportStatus,
            "Message sent successfully. Our support team will review it.",
            "ok"
          );
  ...
  if (deleteForm) {
    ...
    deleteForm.addEventListener(
      ...
      async function (e) {
        ...
        var name =
          byId("dName").value.trim();

        var contact =
          byId("dEmail").value.trim();

        var reason =
          byId("dReason").value.trim();

        var confirmed =
          byId("dConfirm").checked;

        var honeypot =
          byId("deleteFormWebsite");
        ...
        if (
          ...
          setStatus(
            deleteStatus,
            "Please complete the required fields and confirm before submitting.",
            "err"
          );
        ...
        try {
          ...
          setStatus(
            deleteStatus,
            "Deletion request submitted successfully. We may contact you to verify ownership before deletion.",
            "ok"
          );
